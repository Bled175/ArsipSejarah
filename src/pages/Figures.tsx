    ...
    <div className="min-h-screen bg-[#F7F3EF] flex flex-col font-sans text-stone-800">
      <nav className="h-16 px-8 border-b border-stone-200 flex items-center justify-between bg-white sticky top-0 z-50">
        ...
        <div className="hidden md:flex gap-8 text-[10px] font-bold uppercase tracking-[0.2em] text-stone-400">
          <Link to="/explore" className="hover:text-accent transition-colors">Peta Sejarah</Link>
          <Link to="/tokoh" className="text-accent border-b-2 border-accent pb-1">Daftar Tokoh</Link>
